...
public class CrearUsuario extends javax.swing.JDialog {
     ...
     */
       ...
       private Usuarios usuario; // DEBE ESTAR DECLARADO E INICIALIZADO 


   

    public CrearUsuario(java.awt.Frame parent, boolean modal, Usuarios usuario) {
        super(parent, modal);
        initComponents();
        lblAlerta.setVisible(false);
         this.setLocationRelativeTo(null);
       this.usuario = usuario; // MEDIANTE EL CONSTRUCTOR DE LAVENTANA CADA VEZ QUE SE LLAMA ESTA VENTANA
