...
public class GestionPedidos {
	...
	private Pedidos buscar(String issn) {
    ...
    public void crearPedido(String issn, String nombre, CategoriasLibros tema, int cantvendida, int cantdisponible, String descripcion, double precio) {
        Pedidos newPedido = new Pedidos(issn, nombre, tema, cantvendida, cantdisponible, descripcion, precio);
        this.pedidos.insert(newPedido);
    }

    public void eliminarPedidos(String issn) throws Exception {
        pedidos.delete(buscar(issn));
    }
