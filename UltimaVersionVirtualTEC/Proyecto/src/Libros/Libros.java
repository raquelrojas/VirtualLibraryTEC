...
import static modelo.enums.CategoriasLibros.NINGUNO;
...
public class Libros {
    ...
    public Libros(String issn, String nombre, CategoriasLibros  tema, int cantvendida, int cantdisponible, String descripcion,String libreria, double precio){
        this.nombre = nombre;
        this.tema = tema;
