...
public class CrearLibreria extends javax.swing.JDialog {
    ...
    private void btn_crearActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btn_crearActionPerformed
       ...
       // ESTAS VARIABLES SIRVEN PARA GUARDAR LA INFORMACION DE LOS TEXTFIELDS.
        ...
        //Hacemos condicion para validar
        if (this.txtid.getText().isEmpty() || this.txtnombre.getText().isEmpty() || this.txtpais.getText().isEmpty()||
                this.txtubicacion.getText().isEmpty() || this.txttelefono.getText().isEmpty()|| this.txthorario.getText().isEmpty()){
            JOptionPane.showMessageDialog(this, "Debe llenar todos los campos");
            
        } else{//Crea el libro si no esta vacía.
